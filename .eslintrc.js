module.exports = {
  ...
  rules: {
    'import/prefer-default-export': 'off', // 關閉export時必須存在export default
    'no-param-reassign': 'off', // 關閉禁止对函数参数再赋值
    'no-unused-vars': 'off', // 關閉
    'no-promise-executor-return': 'off', // 關閉从Promise执行函数中返回值
